...
class SettingsStateMapper extends ClassMapperBase<SettingsState> {
  ...
  static bool _$sendSequentialFinalize(SettingsState v) =>
      v.sendSequentialFinalize;
  static const Field<SettingsState, bool> _f$sendSequentialFinalize =
      Field('sendSequentialFinalize', _$sendSequentialFinalize);
  ...
  final MappableFields<SettingsState> fields = const {
    ...
    #sendSequentialFinalize: _f$sendSequentialFinalize,
  ...
  static SettingsState _instantiate(DecodingData data) {
    return SettingsState(
        ...
        sendSequentialFinalize: data.dec(_f$sendSequentialFinalize),
...
class _SettingsStateCopyWithImpl<$R, $Out>
  ...
  $R call(
      ...
      $apply(FieldCopyWithData({
        ...
        if (sendSequentialFinalize != null)
          #sendSequentialFinalize: sendSequentialFinalize,
  ...
  SettingsState $make(CopyWithData data) => SettingsState(
      ...
      sendSequentialFinalize:
          data.get(#sendSequentialFinalize, or: $value.sendSequentialFinalize),
      saveWindowPlacement:
